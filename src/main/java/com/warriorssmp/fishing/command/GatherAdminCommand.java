package com.warriorssmp.fishing.command;
    ...
    private void handleMaster(CommandSender sender, String[] args) {
        ...
        if (args[0].equalsIgnoreCase("set")) {
            ...
            villager.getPersistentDataContainer().set(
                    new NamespacedKey(plugin, "angler_npc"), PersistentDataType.BOOLEAN, true);
            ...
            int removed = 0;
            NamespacedKey key = new NamespacedKey(plugin, "angler_npc");
