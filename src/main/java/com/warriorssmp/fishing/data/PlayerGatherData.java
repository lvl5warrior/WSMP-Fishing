...
public final class PlayerGatherData {
    ...
    /** Every 70th catch (lifetime, doesn't reset on logout) rolls a 25% chance
     *  at a free 5-minute Fishing Buff — the earned counterpart to the paid one. */
    public int catchesTowardMilestone = 0;

    /** Fishdex — every distinct catchable material discovered, independent of
     *  tasks/tiers. Fishing-specific collection feature. */
    public final Set<Material> fishdexDiscovered = new HashSet<>();
    public boolean fishdexRewardClaimed = false;
    /** Lifetime count of each material ever caught, shown on the Fishdex page. */
    public final Map<Material, Integer> fishdexCatchCounts = new HashMap<>();
    ...
    public void resetAll() {
        ...
        catchesTowardMilestone = 0;
        fishdexDiscovered.clear();
        fishdexRewardClaimed = false;
        fishdexCatchCounts.clear();
